...
//        PhantomJSDriverService tt = PHANTOMJS_EXECUTABLE_PATH_PROPERTY;
    ...
    public static PhantomJsDriverFactory getStaticInstance(){
        ...
        desiredCapabilities.setCapability(org.openqa.selenium.phantomjs.PhantomJSDriverService.PHANTOMJS_CLI_ARGS,new String[]{"--web-security=false" , "--ssl-protocol=any" , "--ignore-ssl-errors=yes" , "--debug=true" , "--webdriver-loglevel=DEBUG"});
