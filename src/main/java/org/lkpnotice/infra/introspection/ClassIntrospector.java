...
public class ClassIntrospector {
    ...
    static void test4() throws IllegalAccessException {
        final ClassIntrospector ci = new ClassIntrospector();

        ObjectInfo res;

        res = ci.introspect( new ConcurrentSkipListSet<>() );
        System.out.println( res.getDeepSize() );
    }

    static void test3() throws IllegalAccessException {
        final ClassIntrospector ci = new ClassIntrospector();
    ...
    static void test2() throws IllegalAccessException {
        ...
        res = ci.introspect( new HashSet<>() );
        System.out.println( res.getDeepSize() );
    }

    static void test1() throws IllegalAccessException {
        final ClassIntrospector ci = new ClassIntrospector();
